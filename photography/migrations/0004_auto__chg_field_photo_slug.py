...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'photography_photo', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Photo.slug'
        db.alter_column(u'photography_photo', 'slug', self.gf('django.db.models.fields.SlugField')(default=datetime.datetime(2015, 6, 25, 0, 0), max_length=50))
